 ...
 * Refer to: http://www.obviex.com/samples/dpapi.aspx
 */
...
internal class DPAPI_OBV
{
                                 ...
                                 string? description)
    {
        ...
        {
            if (plainTextBlob.pbData != nint.Zero)
                Marshal.FreeHGlobal(plainTextBlob.pbData);

            if (cipherTextBlob.pbData != nint.Zero)
                Marshal.FreeHGlobal(cipherTextBlob.pbData);

            if (entropyBlob.pbData != nint.Zero)
