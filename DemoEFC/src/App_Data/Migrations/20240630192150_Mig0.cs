    ...
    public partial class Mig0 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SemtBucakBeldeId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SemtBucakBeldeAdi = table.Column<string>(type: "text", nullable: false),
                    IlceId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SemtBucakBeldeler", x => x.SemtBucakBeldeId);
                    table.ForeignKey(
                        name: "FK_SemtBucakBeldeler_Ilceler_IlceId",
                        column: x => x.IlceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Mahalleler_SemtBucakBeldeler_SemtBucakBeldeId",
                        column: x => x.SemtBucakBeldeId,
                        principalTable: "SemtBucakBeldeler",
                        principalColumn: "SemtBucakBeldeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Mahalleler_SemtBucakBeldeId",
                table: "Mahalleler",
                column: "SemtBucakBeldeId");

            migrationBuilder.CreateIndex(
                name: "IX_SemtBucakBeldeler_IlceId",
